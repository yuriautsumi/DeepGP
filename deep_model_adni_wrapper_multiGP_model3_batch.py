## Model 3 
'''
Trains DNN layer in batches of group data (random order) 
'''
...
for i in range(0,4): #0 to 3
    ...
    for b in range(loop_count):
        ...
        for ID in g3_fold_tst_ind: 
            ...
            _ = save_to_mat(g3_MAT_LOOP_TESTING_FOLDER_DIR, ID, g3_x_s, g3_y_s, g3_x_a, g3_y_a, g3_g_t, g3_deep_model2, g3_sgp_test_m, g3_sgp_test_s, g3_tst_pat, optimized_params=None, gp_layer=g3_gp_layer2, kgp_model=True, tst_pat=True)
