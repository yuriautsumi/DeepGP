...
#for i in range(0,1): #0 to 3
    ...
    base_weights, g1_z, g2_z, g3_z, base_model = call_base_model_m3_all_drop_reg(x_s, y_s, xtest_all, ytest_all, g1_x_s, g2_x_s, g3_x_s, drop, reg, deep_layer_dims = 128, epochs=50)
...
#        deep_layer_dgp1_1 = Dense(128, activation = 'relu', weights = dnn_weights, trainable = True, kernel_regularizer=regularizers.l2(reg), activity_regularizer=regularizers.l1(reg))(inputs_dgp1_1)
#        dropout1 = Dropout(drop)(deep_layer_dgp1_1)
#        outputs_dgp1_1 = gp_layer1_1(dropout1)
#        
...
#        deep_layer_dgp1_2 = Dense(128, activation = 'relu', weights = dnn_weights, trainable = True, kernel_regularizer=regularizers.l2(reg), activity_regularizer=regularizers.l1(reg))(inputs_dgp1_2)
#        dropout2 = Dropout(drop)(deep_layer_dgp1_2)
#        outputs_dgp1_2 = gp_layer1_2(dropout2)
#        
...
#        deep_layer_dgp1_3 = Dense(128, activation = 'relu', weights = dnn_weights, trainable = True, kernel_regularizer=regularizers.l2(reg), activity_regularizer=regularizers.l1(reg))(inputs_dgp1_3)
#        dropout3 = Dropout(drop)(deep_layer_dgp1_3)
#        outputs_dgp1_3 = gp_layer1_3(dropout3)
#        
...
#        print('Group 3 - Deep Model 1:', g3_deep_model1.summary())
        ...
        g1_gpml_model, g1_optimized_params = trainGP(g1_z_modified, g1_y_s, g1_dimensions, g1_hyp, train_opt, inf_method, mean_fxn, cov_fxn, lik_fxn, dlik_fxn, iters=200)
        g2_gpml_model, g2_optimized_params = trainGP(g2_z_modified, g2_y_s, g2_dimensions, g2_hyp, train_opt, inf_method, mean_fxn, cov_fxn, lik_fxn, dlik_fxn, iters=200)
        g3_gpml_model, g3_optimized_params = trainGP(g3_z_modified, g3_y_s, g3_dimensions, g3_hyp, train_opt, inf_method, mean_fxn, cov_fxn, lik_fxn, dlik_fxn, iters=200)
        ...
        g1_deep_layer_dgp2 = Dense(128, activation = 'relu', weights = dnn_weights, trainable = False, kernel_regularizer=regularizers.l2(reg), activity_regularizer=regularizers.l1(reg))(g1_inputs_dgp2)
        g1_dropout2 = Dropout(drop)(g1_deep_layer_dgp2)
        g1_outputs_dgp2 = g1_gp_layer2(g1_dropout2)
        ...
        g2_deep_layer_dgp2 = Dense(128, activation = 'relu', weights = dnn_weights, trainable = False, kernel_regularizer=regularizers.l2(reg), activity_regularizer=regularizers.l1(reg))(g2_inputs_dgp2)
        g2_dropout2 = Dropout(drop)(g2_deep_layer_dgp2)
        g2_outputs_dgp2 = g2_gp_layer2(g2_dropout2)
        ...
        g3_deep_layer_dgp2 = Dense(128, activation = 'relu', weights = dnn_weights, trainable = False, kernel_regularizer=regularizers.l2(reg), activity_regularizer=regularizers.l1(reg))(g3_inputs_dgp2)
        g3_dropout2 = Dropout(drop)(g3_deep_layer_dgp2)
        g3_outputs_dgp2 = g3_gp_layer2(g3_dropout2)
...
#            
#            _ = save_to_mat(g1_MAT_LOOP_TRAINING_FOLDER_DIR, ID, g1_x_s, g1_y_s, g1_x_dict_s, g1_y_dict_s, g1_y_dict_s, g1_deep_model2, g1_sgp_train_m, g1_sgp_train_s, optimized_params=None, gp_layer=g1_gp_layer2, kgp_model=True)
#                
#        for ID in g1_fold_tst_ind: 
#            
#            print('----- TEST PATIENT: %s -----'%(ID))
#            
#            _ = save_to_mat(g1_MAT_LOOP_TESTING_FOLDER_DIR, ID, g1_x_s, g1_y_s, g1_x_a, g1_y_a, g1_g_t, g1_deep_model2, g1_sgp_test_m, g1_sgp_test_s, optimized_params=None, gp_layer=g1_gp_layer2, kgp_model=True)
#
#        for ID in g2_fold_tr_ind: 
#            
#            print('----- TRAINING PATIENT: %s -----'%(ID))
#            
#            _ = save_to_mat(g2_MAT_LOOP_TRAINING_FOLDER_DIR, ID, g2_x_s, g2_y_s, g2_x_dict_s, g2_y_dict_s, g2_y_dict_s, g2_deep_model2, g2_sgp_train_m, g2_sgp_train_s, optimized_params=None, gp_layer=g2_gp_layer2, kgp_model=True)
#                
#        for ID in g2_fold_tst_ind: 
#            
#            print('----- TEST PATIENT: %s -----'%(ID))
#            
#            _ = save_to_mat(g2_MAT_LOOP_TESTING_FOLDER_DIR, ID, g2_x_s, g2_y_s, g2_x_a, g2_y_a, g2_g_t, g2_deep_model2, g2_sgp_test_m, g2_sgp_test_s, optimized_params=None, gp_layer=g2_gp_layer2, kgp_model=True)
#            
#        for ID in g3_fold_tr_ind: 
#            
#            print('----- TRAINING PATIENT: %s -----'%(ID))
#            
#            _ = save_to_mat(g3_MAT_LOOP_TRAINING_FOLDER_DIR, ID, g3_x_s, g3_y_s, g3_x_dict_s, g3_y_dict_s, g3_y_dict_s, g3_deep_model2, g3_sgp_train_m, g3_sgp_train_s, optimized_params=None, gp_layer=g3_gp_layer2, kgp_model=True)
#                
#        for ID in g3_fold_tst_ind: 
#            
#            print('----- TEST PATIENT: %s -----'%(ID))
#            
#            _ = save_to_mat(g3_MAT_LOOP_TESTING_FOLDER_DIR, ID, g3_x_s, g3_y_s, g3_x_a, g3_y_a, g3_g_t, g3_deep_model2, g3_sgp_test_m, g3_sgp_test_s, optimized_params=None, gp_layer=g3_gp_layer2, kgp_model=True)
    ...
    for ID in g1_fold_tst_ind: 
        ...
        g1_m_s_patient, g1_s_s_patient, g1_y_a_patient = save_to_mat_final(g1_MAT_FINAL_FOLDER_DIR, ID, g1_x_s, g1_y_s, g1_x_a, g1_y_a, g1_g_t, g1_deep_model2, g1_gp_layer2, g1_sgp_test_m, g1_sgp_test_s, g1_tst_inds, base_weights, deep_layer_dims=128, tst_pat=True)
    ...
    for ID in g2_fold_tst_ind: 
        ...
        g2_m_s_patient, g2_s_s_patient, g2_y_a_patient = save_to_mat_final(g2_MAT_FINAL_FOLDER_DIR, ID, g2_x_s, g2_y_s, g2_x_a, g2_y_a, g2_g_t, g2_deep_model2, g2_gp_layer2, g2_sgp_test_m, g2_sgp_test_s, g2_tst_inds, base_weights, deep_layer_dims=128, tst_pat=True)
    ...
    for ID in g3_fold_tst_ind: 
        ...
        g3_m_s_patient, g3_s_s_patient, g3_y_a_patient = save_to_mat_final(g3_MAT_FINAL_FOLDER_DIR, ID, g3_x_s, g3_y_s, g3_x_a, g3_y_a, g3_g_t, g3_deep_model2, g3_gp_layer2, g3_sgp_test_m, g3_sgp_test_s, g3_tst_inds, base_weights, deep_layer_dims=128, tst_pat=True)
