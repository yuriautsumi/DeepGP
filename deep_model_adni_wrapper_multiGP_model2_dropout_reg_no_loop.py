...
for i in range(0,10): #0 to 9
    ...
    base_weights, z, base_model = call_base_model_drop_reg(x_s, y_s, xtest_all, ytest_all, drop, reg, deep_layer_dims = 128, epochs=50)
...
#        print('Deep Model 1:', deep_model1.summary())
        ...
        gpml_model, optimized_params = trainGP(z_modified, y_s, dimensions, hyp, train_opt, inf_method, mean_fxn, cov_fxn, lik_fxn, dlik_fxn, iters=200)
