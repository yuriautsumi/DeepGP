...
for i in range(0,1): #0 to 3
    ...
    base_weights, g1_z, g2_z, g3_z, base_model = call_base_model_m3_all_drop(x_s, y_s, xtest_all, ytest_all, g1_x_s, g2_x_s, g3_x_s, drop, deep_layer_dims = 128) 
    ...
    for b in range(loop_count):
        ...
        deep_layer_dgp1_1 = Dense(128, activation = 'relu', weights = dnn_weights, trainable = True)(inputs_dgp1_1)
        ...
        deep_layer_dgp1_2 = Dense(128, activation = 'relu', weights = dnn_weights, trainable = True)(inputs_dgp1_2)
        ...
        deep_layer_dgp1_3 = Dense(128, activation = 'relu', weights = dnn_weights, trainable = True)(inputs_dgp1_3)
        ...
        g1_deep_layer_dgp2 = Dense(128, activation = 'relu', weights = dnn_weights, trainable = False)(g1_inputs_dgp2)
        ...
        g2_deep_layer_dgp2 = Dense(128, activation = 'relu', weights = dnn_weights, trainable = False)(g2_inputs_dgp2)
        ...
        g3_deep_layer_dgp2 = Dense(128, activation = 'relu', weights = dnn_weights, trainable = False)(g3_inputs_dgp2)
