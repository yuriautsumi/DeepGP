...
#    pathlib.Path(ERROR_FOLD_FOLDER_DIR).mkdir(parents=True, exist_ok=True) #make folder 
    ...
    for ID in g1_fold_tst_ind: 
        ...
        g1_m_s_patient, g1_s_s_patient, g1_y_a_patient = save_to_mat_final(g1_MAT_FINAL_FOLDER_DIR, ID, x_s1, y_s1, g1_x_a, g1_y_a, g1_g_t, g1_deep_model2, g1_gp_layer2, g1_sgp_test_m, g1_sgp_test_s, base_weights)
        
    for ID in g2_fold_tst_ind: 
        
        print('----- TEST PATIENT: %s -----'%(ID))
        
        g2_m_s_patient, g2_s_s_patient, g2_y_a_patient = save_to_mat_final(g2_MAT_FINAL_FOLDER_DIR, ID, x_s2, y_s2, g2_x_a, g2_y_a, g2_g_t, g2_deep_model2, g2_gp_layer2, g2_sgp_test_m, g2_sgp_test_s, base_weights)
        
    for ID in g3_fold_tst_ind: 
        
        print('----- TEST PATIENT: %s -----'%(ID))
        
        g3_m_s_patient, g3_s_s_patient, g3_y_a_patient = save_to_mat_final(g3_MAT_FINAL_FOLDER_DIR, ID, x_s3, y_s3, g3_x_a, g3_y_a, g3_g_t, g3_deep_model2, g3_gp_layer2, g3_sgp_test_m, g3_sgp_test_s, base_weights)
